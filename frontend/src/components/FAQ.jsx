      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <div className="mt-12 text-center backdrop-blur-xl bg-linear-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-400/30 rounded-2xl p-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl px-7 py-4 text-white font-bold shadow-lg transition-all hover:-translate-y-1 bg-green-500 hover:bg-green-600"
          >
